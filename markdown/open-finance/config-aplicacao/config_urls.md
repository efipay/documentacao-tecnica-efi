...
<div className="light"> 
string *Se não informado, assume o valor padrão que é mtls.
</div>
<br/>
...
*mtls* - A comunicação exigirá um mtls configurado. Para mais detalhes, acesse o <a href="https://dev.gerencianet.com.br/docs/api-pix-endpoints#entendendo-o-padr%C3%A3o-mtls" target="_blank">link</a>.
